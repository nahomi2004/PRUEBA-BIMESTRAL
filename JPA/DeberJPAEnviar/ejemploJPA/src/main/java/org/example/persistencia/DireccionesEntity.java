...
public class DireccionesEntity {
    ...
    public DireccionesEntity(int idDir, String calle1, String calle2) {
        this.idDir = idDir;
        this.calle1 = calle1;
        this.calle2 = calle2;
    }

    public DireccionesEntity(int idDir, String calle1, String calle2, ClientesEntity clientesByIdCli) {
        this.idDir = idDir;
        this.calle1 = calle1;
        this.calle2 = calle2;
        this.idCli = clientesByIdCli.getIdCliente();
